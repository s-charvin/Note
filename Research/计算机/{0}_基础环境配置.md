...
`pip install audioread keras pandas redis redis opencv-python matplotlib scikit-learn  selenium==3.141.0 tqdm nvitop nlpaug librosa==0.9.2 decord g-mlp-pytorch opensmile==2.4.1 sklearn torchinfo pretrainedmodels transformers tensorboard area_attention ffmpeg pytorchvideo fairscale apex ava`
