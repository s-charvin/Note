...
- ❔\[重点关注问题\]: 超参数选择问题和训练数据库样本问题
- :method 解决方法: 在这篇文章中，作者提出了两种不同的方法来帮助 DL 网络更有效地收敛，即添加智能训练样本和参考样本方法。
- 怎么做的: 在这篇文章中，作者使用了一种贪心算法来选择智能训练样本和参考样本。这种算法可以应用于训练和参考样本的选择。通过比较随机选择和基于贪心算法的选择策略，作者发现基于贪心算法的选择策略对于训练样本和参考样本都具有显著优势。 
