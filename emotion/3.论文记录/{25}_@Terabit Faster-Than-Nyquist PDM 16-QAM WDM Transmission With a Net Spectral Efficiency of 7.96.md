...
![]({25}_@Terabit%20Faster-Than-Nyquist%20PDM%2016-QAM%20WDM%20Transmission%20With%20a%20Net%20Spectral%20Efficiency%20of%207.96.assets/image-20220519105032.png)
...
![]({25}_@Terabit%20Faster-Than-Nyquist%20PDM%2016-QAM%20WDM%20Transmission%20With%20a%20Net%20Spectral%20Efficiency%20of%207.96.assets/image-20220519192041.png)
...
![]({25}_@Terabit%20Faster-Than-Nyquist%20PDM%2016-QAM%20WDM%20Transmission%20With%20a%20Net%20Spectral%20Efficiency%20of%207.96.assets/image-20220519144533.png)

图 1(c) 显示了发送的 Nyquist 16-QAM 信号的帧结构。前导码包括两个 63-symbol synchronization序列和两个670-symbol的训练序列。为了获得Jones空间中的$2\times 2$信道响应矩阵，训练序列由两对time-multiplexed patterns（时分复用？）组成，跨越两个极化$\left[t_{x} \text{ }  t_{y}\right]^ {T}$ in (1), $$ \left(\begin{array}{l} t_{x} \\ t_{y} \end{array}\right)=\left(\begin{array}{ cc} M &0 \\ 0 & M \end{array}\right) $$
...
![]({25}_@Terabit%20Faster-Than-Nyquist%20PDM%2016-QAM%20WDM%20Transmission%20With%20a%20Net%20Spectral%20Efficiency%20of%207.96.assets/image-20220519154931.png)
...
![]({25}_@Terabit%20Faster-Than-Nyquist%20PDM%2016-QAM%20WDM%20Transmission%20With%20a%20Net%20Spectral%20Efficiency%20of%207.96.assets/image-20220519155815.png)
...
![]({25}_@Terabit%20Faster-Than-Nyquist%20PDM%2016-QAM%20WDM%20Transmission%20With%20a%20Net%20Spectral%20Efficiency%20of%207.96.assets/image-20220519155908.png)
...
![]({25}_@Terabit%20Faster-Than-Nyquist%20PDM%2016-QAM%20WDM%20Transmission%20With%20a%20Net%20Spectral%20Efficiency%20of%207.96.assets/image-20220519155620.png)
...
![]({25}_@Terabit%20Faster-Than-Nyquist%20PDM%2016-QAM%20WDM%20Transmission%20With%20a%20Net%20Spectral%20Efficiency%20of%207.96.assets/image-20220519155539.png)
...
![]({25}_@Terabit%20Faster-Than-Nyquist%20PDM%2016-QAM%20WDM%20Transmission%20With%20a%20Net%20Spectral%20Efficiency%20of%207.96.assets/image-20220519155426.png)
...
![]({25}_@Terabit%20Faster-Than-Nyquist%20PDM%2016-QAM%20WDM%20Transmission%20With%20a%20Net%20Spectral%20Efficiency%20of%207.96.assets/image-20220519155407.png)
...
![]({25}_@Terabit%20Faster-Than-Nyquist%20PDM%2016-QAM%20WDM%20Transmission%20With%20a%20Net%20Spectral%20Efficiency%20of%207.96.assets/image-20220519155320.png)
...
![]({25}_@Terabit%20Faster-Than-Nyquist%20PDM%2016-QAM%20WDM%20Transmission%20With%20a%20Net%20Spectral%20Efficiency%20of%207.96.assets/image-20220519084405.png)
...
![]({25}_@Terabit%20Faster-Than-Nyquist%20PDM%2016-QAM%20WDM%20Transmission%20With%20a%20Net%20Spectral%20Efficiency%20of%207.96.assets/image-20220519084419.png)
...
![]({25}_@Terabit%20Faster-Than-Nyquist%20PDM%2016-QAM%20WDM%20Transmission%20With%20a%20Net%20Spectral%20Efficiency%20of%207.96.assets/image-20220519084545.png)

2）**模拟通信系统结构**

![]({25}_@Terabit%20Faster-Than-Nyquist%20PDM%2016-QAM%20WDM%20Transmission%20With%20a%20Net%20Spectral%20Efficiency%20of%207.96.assets/image-20220519084549.png)
...
![]({25}_@Terabit%20Faster-Than-Nyquist%20PDM%2016-QAM%20WDM%20Transmission%20With%20a%20Net%20Spectral%20Efficiency%20of%207.96.assets/image-20220519090734.png)

![]({25}_@Terabit%20Faster-Than-Nyquist%20PDM%2016-QAM%20WDM%20Transmission%20With%20a%20Net%20Spectral%20Efficiency%20of%207.96.assets/image-20220519090952.png)
...
![]({25}_@Terabit%20Faster-Than-Nyquist%20PDM%2016-QAM%20WDM%20Transmission%20With%20a%20Net%20Spectral%20Efficiency%20of%207.96.assets/image-20220519100555.png)

16QAM星座图，每个蓝点代表一组I和Q，对应一组A和φ，也即对应了一个波形，总共16种组合，也就是携带了4bit信息。

3）**数字通信系统结构**

![]({25}_@Terabit%20Faster-Than-Nyquist%20PDM%2016-QAM%20WDM%20Transmission%20With%20a%20Net%20Spectral%20Efficiency%20of%207.96.assets/image-20220519084556.png)

相比于普适性通信系统结构，数字通信系统结构除了增加了**对数字信号的调制和解调**，还多了**信源与信道的编码与译码**，以及**加密和解密**过程。

![]({25}_@Terabit%20Faster-Than-Nyquist%20PDM%2016-QAM%20WDM%20Transmission%20With%20a%20Net%20Spectral%20Efficiency%20of%207.96.assets/image-20220519084608.png)
...
![]({25}_@Terabit%20Faster-Than-Nyquist%20PDM%2016-QAM%20WDM%20Transmission%20With%20a%20Net%20Spectral%20Efficiency%20of%207.96.assets/image-20220519091244.png)
...
![]({25}_@Terabit%20Faster-Than-Nyquist%20PDM%2016-QAM%20WDM%20Transmission%20With%20a%20Net%20Spectral%20Efficiency%20of%207.96.assets/image-20220519095506.png)
...
![]({25}_@Terabit%20Faster-Than-Nyquist%20PDM%2016-QAM%20WDM%20Transmission%20With%20a%20Net%20Spectral%20Efficiency%20of%207.96.assets/image-20220519103134.png)
...
![]({25}_@Terabit%20Faster-Than-Nyquist%20PDM%2016-QAM%20WDM%20Transmission%20With%20a%20Net%20Spectral%20Efficiency%20of%207.96.assets/image-20220519104450.png)
...
![]({25}_@Terabit%20Faster-Than-Nyquist%20PDM%2016-QAM%20WDM%20Transmission%20With%20a%20Net%20Spectral%20Efficiency%20of%207.96.assets/image-20220519104517.png)

二者子载波间相乘在积分为0；

但符号s1调制频率为f0的子载波后经过第一径发送出去，符号s3调制频率为2f0的子载波后经过第二径发送出去，二者的子载波间的关系如下：

![]({25}_@Terabit%20Faster-Than-Nyquist%20PDM%2016-QAM%20WDM%20Transmission%20With%20a%20Net%20Spectral%20Efficiency%20of%207.96.assets/image-20220519104540.png)
